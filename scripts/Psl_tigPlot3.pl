...
#	if($note && $note ne '-'){
#		$png = $note."_plot_".$prefix."_".$qtpref."_".$grp.".png";
#		$png1 = $note."_plot1_".$prefix."_".$qtpref."_".$grp.".png";
#		$png2 = $note."_plot2_".$prefix."_".$qtpref."_".$grp.".png";
#		$png3 = $note."_plot3_".$prefix."_".$qtpref."_".$grp.".png";
#		$png4 = $note."_plot4_".$prefix."_".$qtpref."_".$grp.".png";
#	}
