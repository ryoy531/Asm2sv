...
($r7_lessConserved, $hgeneclass) = Select_lessConverved($r7, $hgeneclass, "promoter_less_$svscore_nsample_th", $pseudogoipr, $svscore_nsample_th);
($r9_lessConserved, $hgeneclass) = Select_lessConverved($r9, $hgeneclass, "utr3_less_$svscore_nsample_th", $pseudogoipr, $svscore_nsample_th);
...
($r11_lessConserved, $hgeneclass) = Select_lessConverved($r11, $hgeneclass, "val_gnall_less_$svscore_nsample_th", $pseudogoipr, $svscore_nsample_th);
($r12_lessConserved, $hgeneclass) = Select_lessConverved($r12, $hgeneclass, "raw_gnall_less_$svscore_nsample_th", $pseudogoipr, $svscore_nsample_th);
($r15_lessConserved, $hgeneclass) = Select_lessConverved($r15, $hgeneclass, "prot_gnall_less_$svscore_nsample_th", $pseudogoipr, $svscore_nsample_th);
($r17_lessConserved, $hgeneclass) = Select_lessConverved($r17, $hgeneclass, "promoter_gnall_less_$svscore_nsample_th", $pseudogoipr, $svscore_nsample_th);
($r19_lessConserved, $hgeneclass) = Select_lessConverved($r19, $hgeneclass, "utr3_gnall_less_$svscore_nsample_th", $pseudogoipr, $svscore_nsample_th);
...
($r7_lessConservedwoTRs, $hgeneclass) = Select_lessConverved($r7, $hgeneclass, "null", $hgoipr, $svscore_nsample_th);
($r9_lessConservedwoTRs, $hgeneclass) = Select_lessConverved($r9, $hgeneclass, "null", $hgoipr, $svscore_nsample_th);
...
my $rfile11 = "$dir/gene_disrupt_gnall_q-".$nsample.".csv";
my $rfile11B = "$dir/gene_indel_gnall_q-".$nsample.".csv";
my $rfile11C = "$dir/all_indel_gnall_q-".$nsample.".csv";
my $rfile12 = "$dir/raw_gnall_q-".$nsample.".csv";
my $rfile15 = "$dir/protein_gnall_q-".$nsample.".csv";
my $rfile17 = "$dir/promoter_indel_gnall_q-".$nsample.".csv";
my $rfile19 = "$dir/3UTR_indel_gnall_q-".$nsample.".csv";
...
my $rfile7l = "$dir/promoter_indel_q-".$nsample."_lessConserved_th-".$svscore_nsample_th.".csv";
my $rfile9l = "$dir/3UTR_indel_q-".$nsample."_lessConserved_th-".$svscore_nsample_th.".csv";
...
my $rfile11l = "$dir/gene_disrupt_gnall_q-".$nsample."_lessConserved_th-".$svscore_nsample_th.".csv";
my $rfile12l = "$dir/raw_gnall_q-".$nsample."_lessConserved_th-".$svscore_nsample_th.".csv";
my $rfile15l = "$dir/protein_gnall_q-".$nsample."_lessConserved_th-".$svscore_nsample_th.".csv";
my $rfile17l = "$dir/promoter_indel_gnall_q-".$nsample."_lessConserved_th-".$svscore_nsample_th.".csv";
my $rfile19l = "$dir/3UTR_indel_gnall_q-".$nsample."_lessConserved_th-".$svscore_nsample_th.".csv";
...
my $rfile7lTRs = "$dir/promoter_indel_q-".$nsample."_lessConserved_th-".$svscore_nsample_th."_woTransposon.csv";
my $rfile9lTRs = "$dir/3UTR_indel_q-".$nsample."_lessConserved_th-".$svscore_nsample_th."_woTransposon.csv";
...
my $rfile11lTRs = "$dir/gene_disrupt_gnall_q-".$nsample."_lessConserved_th-".$svscore_nsample_th."_woTransposon.csv";
my $rfile12lTRs = "$dir/raw_gnall_q-".$nsample."_lessConserved_th-".$svscore_nsample_th."_woTransposon.csv";
my $rfile15lTRs = "$dir/protein_gnall_q-".$nsample."_lessConserved_th-".$svscore_nsample_th."_woTransposon.csv";
my $rfile17lTRs = "$dir/promoter_indel_gnall_q-".$nsample."_lessConserved_th-".$svscore_nsample_th."_woTransposon.csv";
my $rfile19lTRs = "$dir/3UTR_indel_gnall_q-".$nsample."_lessConserved_th-".$svscore_nsample_th."_woTransposon.csv";
...
#-------------------------------
my $rfile11_nmatrix = "$dir/gene_disrupt_gnall_q-".$nsample."_num-matrix.csv";
my $rfile11B_nmatrix = "$dir/gene_indel_gnall_q-".$nsample."_num-matrix.csv";
my $rfile11V_nmatrix = "$dir/forClust_gene_indel_gnall_q-".$nsample."_native.csv";
my $rfile11R_nmatrix = "$dir/forClust_gene_indel_gnall_q-".$nsample."_relative.csv";
my $rfile11N_nmatrix = "$dir/forClust_gene_indel_gnall_q-".$nsample."_averaged.csv";
my $rfile11L_nmatrix = "$dir/forClust_gene_indel_gnall_q-".$nsample."_log.csv";
my $rfile11Z_nmatrix = "$dir/forClust_gene_indel_gnall_q-".$nsample."_zscore.csv";
my $rfile11RL_nmatrix = "$dir/forClust_gene_indel_gnall_q-".$nsample."_log-relative.csv";
my $rfile11RZ_nmatrix = "$dir/forClust_gene_indel_gnall_q-".$nsample."_zscore-relative.csv";
#-------------------------------
my $rfile11C_nmatrix = "$dir/all_indel_gnall_q-".$nsample."_num-matrix.csv";
my $rfile11CV_nmatrix = "$dir/forClust_all_indel_gnall_q-".$nsample."_native.csv";
my $rfile11CR_nmatrix = "$dir/forClust_all_indel_gnall_q-".$nsample."_relative.csv";
my $rfile11CN_nmatrix = "$dir/forClust_all_indel_gnall_q-".$nsample."_averaged.csv";
my $rfile11CL_nmatrix = "$dir/forClust_all_indel_gnall_q-".$nsample."_log.csv";
my $rfile11CZ_nmatrix = "$dir/forClust_all_indel_gnall_q-".$nsample."_zscore.csv";
my $rfile11CRL_nmatrix = "$dir/forClust_all_indel_gnall_q-".$nsample."_log-relative.csv";
my $rfile11CRZ_nmatrix = "$dir/forClust_all_indel_gnall_q-".$nsample."_zscore-relative.csv";
#-------------------------------
my $rfile11G_nmatrix = "$dir/protein-gene_indel_gnall_q-".$nsample."_num-matrix.csv";
my $rfile11GV_nmatrix = "$dir/forClust_protein-gene_indel_gnall_q-".$nsample."_native.csv";
my $rfile11GR_nmatrix = "$dir/forClust_protein-gene_indel_gnall_q-".$nsample."_relative.csv";
my $rfile11GN_nmatrix = "$dir/forClust_protein-gene_indel_gnall_q-".$nsample."_averaged.csv";
my $rfile11GL_nmatrix = "$dir/forClust_protein-gene_indel_gnall_q-".$nsample."_log.csv";
my $rfile11GZ_nmatrix = "$dir/forClust_protein-gene_indel_gnall_q-".$nsample."_zscore.csv";
my $rfile11GRL_nmatrix = "$dir/forClust_protein-gene_indel_gnall_q-".$nsample."_log-relative.csv";
my $rfile11GRZ_nmatrix = "$dir/forClust_protein-gene_indel_gnall_q-".$nsample."_zscore-relative.csv";
#-------------------------------
my $rfile15_nmatrix = "$dir/protein_gnall_q-".$nsample."_num-matrix.csv";
my $rfile17_nmatrix = "$dir/promoter_indel_gnall_q-".$nsample."_num-matrix.csv";
my $rfile19_nmatrix = "$dir/3UTR_indel_gnall_q-".$nsample."_num-matrix.csv";
...
if(-e $gfile1){
	...
	#SAVE($rfile3lTRs, $r3_lessConservedwoTRs);
...
if($refgenome ne 'null'){
	if($cnt_diffchr > 0 || $cnt_trans > 0){
		...
		my $rfile101M = "$dir/gene_disrupt_gnall_transloc_q-".$nsample.".csv";
		...
		if($cnt_diffchr > 0){
			...
			my $rfile201M = "$dir/gene_disrupt_gnall_transloc-diffchr_q-".$nsample.".csv";
		...
		if($cnt_trans > 0){
			...
			my $rfile301M = "$dir/gene_disrupt_gnall_transloc-samechr_q-".$nsample.".csv";
