...
In the result directory, you can also find a bash script file named `example_command_vgconst.sh`. By running it, user can construct pangenome reference with Vg.
```
